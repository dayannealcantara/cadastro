...
import { CidadesService, IListagemCidade } from '../../shared/service/api/cidades/CidadesService';
...
export const ListagemDeCidades: React.FC = () => {
  ...
  return(
    <LayoutBaseDePagina titulo='Listagem de Cidades' barraDeFerramentas={(<BarraDeFerramentas      
      mostrarInputBusca
      textoDaBusca={busca}
      textoBtn='Nova' 
      aoClicarBtn={() => navigate('/cidades/detalhe/nova')}
