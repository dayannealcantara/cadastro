...
import { CidadesService } from '../../shared/service/api/cidades/CidadesService';
...
export const DetalheDeCidades: React.FC = () => {
  ...
  return(
    <LayoutBaseDePagina titulo={id === 'nova' ? 'Nova cidade' : nome }barraDeFerramentas={<FerramentasDeDetalhes  
      textoBtn='Nova' 
      btnNovo = {id !== 'nova'}
      btnApagar ={id !== 'nova'}
      btnSalvarFechar   
